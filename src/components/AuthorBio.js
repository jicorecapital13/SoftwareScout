    ...
    <div className="entry-author-profile author-profile vcard">
      ...
      <div className="entry-author-follow author-follow">
        <a
          ...
          aria-label="Follow Software Scout on Twitter" // Added aria-label for accessibility
        >
          <span className="kadence-svg-iconset">
            <svg
              ...
              height="28"
              viewBox="0 0 26 28"
              aria-hidden="true" // Marks the SVG as decorative since we have a label
            >
              <title>Twitter</title>
        ...
        <a
          ...
          aria-label="Follow Software Scout on LinkedIn" // Added aria-label for accessibility
        >
          <span className="kadence-svg-iconset">
            <svg
